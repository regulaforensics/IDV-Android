...
implementation("com.regula.idv:face:3.8.+@aar") {
        isTransitive = true
    }

// main dependency
implementation("com.regula.idv:api:3.8.+@aar") {
        isTransitive = true
    }
```
...
implementation("com.regula.documentreader:api:9.6.+@aar") {
        isTransitive = true
    }
